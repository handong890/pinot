...
public final class Schema {
  ...
  public static class SchemaBuilder {
    ...
    public void addTime(@Nonnull TimeGranularitySpec incomingTimeGranularitySpec) {
      schema.addField(new TimeFieldSpec(incomingTimeGranularitySpec));
    }

    public void addTime(@Nonnull TimeGranularitySpec incomingTimeGranularitySpec, @Nonnull Object defaultNullValue) {
