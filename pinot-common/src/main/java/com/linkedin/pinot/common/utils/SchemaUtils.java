...
public class SchemaUtils {
  ...
  /**
   * Given host, port and schemaName, send a http GET request to download the {@link Schema}.
   *
  ...
  /**
   * Given host, port and schema, send a http DELETE request to delete the {@link Schema}.
   *
   * @return <code>true</code> on success.
   * <P><code>false</code> on failure.
   */
